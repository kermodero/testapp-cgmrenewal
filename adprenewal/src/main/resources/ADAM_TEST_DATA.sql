...
VALUES ('', (SELECT ID FROM APP.RECORD_SET WHERE FILE_NAME='GM Renewals'), 
		'4267999615', 
		120049147, 
		'RWKGMRENEWAL-VRX-12345-4267999615-7654333.xml',
		14395,
		'T',
		'T',
		'F',
...
--"ID","ORIGINAL_CLAIM_NUM","RECORD_SET_ID","HEALTH_NUMBER","ADAM_VENDOR_ID","FILE_NAME","CLIENT_AGENT_ID","DEVICE_CATEGORY","FORM_VERSION"
--0,"",1,"4267999615",120049147,C:/TEST/RWKGMRENEWAL-VRX-12345-4267999615-7654321.xml,2017231,GM,"202304"
